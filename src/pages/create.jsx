...
const Create = () => {
  ...
  const Push = async () => {
    if (songs.length > 15) {
      ...
      localStorage.setItem("tapeurl", randomString);
  ...
  const [randomStr, setRandomString] = useState("");
    ...
    <>
      ...
      <div className="create-content">
        <div className="inputs">
          ...
          <div>
            <img
              src={add}
              onClick={() => {
                setNewSong({ name: songname, link: songlink });
              }}
              className="addbtn"
              alt=""
            />
                ...
                return (
                  <div className="cassette">
                    ...
                    <div className="cassette-items">
                      <p>{item["name"]}</p>
                      <img
                        className="cassette-thumb"
                        src={grabLink(item["link"], "mq")}
                        alt=""
                        height="50px"
                      />
                    </div>
        ...
        >
          ...
          <p>https://retrotape.web.app/view?{randomStr}</p>
          <div style={{ display: "flex", gap: "2rem" }}>
            <RWebShare
              data={{
                text: "Take a look at my retrotape, created just for you <3",
                url: "https://retrotape.web.app/view?" + randomStr,
